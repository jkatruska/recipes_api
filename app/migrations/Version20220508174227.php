 ...
 */
final class Version20220508174227 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE photos (id INT AUTO_INCREMENT NOT NULL, user_id INT DEFAULT NULL, `key` VARCHAR(255) NOT NULL, INDEX IDX_876E0D9A76ED395 (user_id), INDEX user_photo (`key`), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
